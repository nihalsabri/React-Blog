...
//       try {
//         const response = await axios.get(`${BASE_URL}/posts?category=${slug}&page=${page}&limit=${postsPerPage}`);
...
//           cover: post.cover
//             ? `${BASE_URL}/uploads/posts/${post.cover}`
...
//                   <CardActionArea>
//                     {post.cover && (
//                       <CardMedia component="img" height="200" src={post.cover} alt={post.title} />
//                     )}
//                     <CardContent>
